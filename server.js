...
app.post('/api/auth/signup', async (req, res) => {
    try {
        ...
        try {
            ...
            // User created in Auth but not in Firestore - still return success with warning
            // We'll try to save again later or admin can fix
        }
        ...
        try {
            ...
            // Continue without token - user will need to login manually
        }
...
// ============================================================
// LOGIN - Using Firebase Admin SDK
// ============================================================
...
app.get('/api/health', (req, res) => {
    res.json({
        ...
        firestore: firebaseInitialized ? 'connected' : 'disconnected',
