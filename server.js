// ============================================================
// HARAKAPAY SERVER - FULL FIRESTORE INTEGRATION
// ============================================================
...
// ============================================================
// HARAKAPAY API FUNCTIONS (Based on Documentation)
// ============================================================
...
// ============================================================
// ORDERS - Read/Write from Firestore
// ============================================================
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log('💳 HarakaPay Integration: Enabled');
    console.log('========================================');
});
