// ============================================================
// HARAKAPAY PRODUCTION SERVER - BACKEND ONLY AUTH
// ============================================================
// All authentication handled server-side with Firebase Admin SDK
// NO Web API Key needed on Frontend
// ============================================================
...
// ============================================================
// LOGIN - Authenticate via Firebase Admin SDK
// ============================================================
app.post('/api/auth/login', async (req, res) => {
    try {
        ...
        // Since we can't sign in with password using Admin SDK directly,
        // we use Firebase Auth REST API with Web API Key (but this is server-side)
        // OR we can use the Firebase Auth REST API
        
        // Method: Use Firebase Auth REST API (Server-side)
        ...
        if (error.response && error.response.data && error.response.data.error) {
            ...
            switch (errorCode) {
                ...
                case 'TOO_MANY_ATTEMPTS_TRY_LATER':
                    ...
                    break;
                default:
                    errorMessage = errorCode || 'Login failed';
            }
        }
...
app.post('/api/auth/forgot-password', async (req, res) => {
    try {
        ...
        res.json({
            ...
            resetLink: resetLink // In production, send via email instead of returning
        });
